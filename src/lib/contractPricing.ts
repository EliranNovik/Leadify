  ...
  return [
    {
      ...
      value: firstPayment,
      value_vat: currency === 'NIS' ? Math.round(firstPayment * 0.18 * 100) / 100 : 0,
    ...
    },
    {
      ...
      value: secondPayment,
      value_vat: currency === 'NIS' ? Math.round(secondPayment * 0.18 * 100) / 100 : 0,
      payment_order: 'Second Payment',
    ...
    },
    {
      ...
      value: thirdPayment,
      value_vat: currency === 'NIS' ? Math.round(thirdPayment * 0.18 * 100) / 100 : 0,
