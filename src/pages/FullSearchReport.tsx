...
const FullSearchReport: React.FC = () => {
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      if (filters.meetingLocation) query = query.ilike('meeting_location', `%${filters.meetingLocation}%`);
      if (filters.meetingScheduler) query = query.ilike('meeting_scheduler', `%${filters.meetingScheduler}%`);
      if (filters.meetingManager) query = query.ilike('manager', `%${filters.meetingManager}%`);
      if (filters.meetingLawyer) query = query.ilike('meeting_lawyer', `%${filters.meetingLawyer}%`);
      if (filters.meetingDate) query = query.gte('meeting_date', filters.meetingDate);
      if (filters.expert) query = query.ilike('expert', `%${filters.expert}%`);
      if (filters.closer) query = query.ilike('closer', `%${filters.closer}%`);
      if (filters.handler) query = query.ilike('handler', `%${filters.handler}%`);
    ...
    <div>
      ...
      <div className="card bg-base-200 shadow-lg p-6 mb-8">
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          ...
          {/* New Meeting & Staff Filters */}
          <div className="form-control flex flex-col col-span-2 sm:col-span-1">
            <label className="label mb-2"><span className="label-text">Meeting Location</span></label>
            <input type="text" className="input input-bordered" onChange={e => handleFilterChange('meetingLocation', e.target.value)} />
          </div>
          <div className="form-control flex flex-col col-span-2 sm:col-span-1">
            <label className="label mb-2"><span className="label-text">Meeting Scheduler</span></label>
            <input type="text" className="input input-bordered" onChange={e => handleFilterChange('meetingScheduler', e.target.value)} />
          </div>
          <div className="form-control flex flex-col col-span-2 sm:col-span-1">
            <label className="label mb-2"><span className="label-text">Meeting Manager</span></label>
            <input type="text" className="input input-bordered" onChange={e => handleFilterChange('meetingManager', e.target.value)} />
          </div>
          <div className="form-control flex flex-col col-span-2 sm:col-span-1">
            <label className="label mb-2"><span className="label-text">Meeting Lawyer</span></label>
            <input type="text" className="input input-bordered" onChange={e => handleFilterChange('meetingLawyer', e.target.value)} />
          </div>
          <div className="form-control flex flex-col col-span-2 sm:col-span-1">
            <label className="label mb-2"><span className="label-text">Meeting Date</span></label>
            <input type="date" className="input input-bordered" onChange={e => handleFilterChange('meetingDate', e.target.value)} />
          </div>
          <div className="form-control flex flex-col col-span-2 sm:col-span-1">
            <label className="label mb-2"><span className="label-text">Expert</span></label>
            <input type="text" className="input input-bordered" onChange={e => handleFilterChange('expert', e.target.value)} />
          </div>
          <div className="form-control flex flex-col col-span-2 sm:col-span-1">
            <label className="label mb-2"><span className="label-text">Closer</span></label>
            <input type="text" className="input input-bordered" onChange={e => handleFilterChange('closer', e.target.value)} />
          </div>
          <div className="form-control flex flex-col col-span-2 sm:col-span-1">
            <label className="label mb-2"><span className="label-text">Handler</span></label>
            <input type="text" className="input input-bordered" onChange={e => handleFilterChange('handler', e.target.value)} />
          </div>
...
export default FullSearchReport; 