...
import { BanknotesIcon, UserGroupIcon, AcademicCapIcon, ChartBarIcon, BriefcaseIcon, InformationCircleIcon, DocumentTextIcon } from '@heroicons/react/24/solid';
...
const CollectionDueReport = ({
  ...
  return (
    <div className="p-4 md:p-8 space-y-6">
      {/* Filters */}
      <div className="card bg-base-100 shadow-none p-6">
