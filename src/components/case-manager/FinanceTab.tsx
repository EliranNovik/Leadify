  ...
  return (
    <div className="w-full px-8">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-8">
        <div>
          <h3 className="text-xl font-bold text-gray-900">Finance Management</h3>
          <p className="text-gray-600">Manage finance plans and payment tracking</p>
        </div>
      </div>
            ...
            <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-8 mb-8">
              ...
              {(() => {
                ...
                return Object.entries(paymentsByContact).map(([contactName, payments]) => (
                  <div key={contactName} className="mb-6">
                    {/* Contact Header */}
                    <div 
                    ...
                    >
                      ...
                      <div className="flex-1">
                        <h5 className="font-semibold text-gray-900">{contactName}</h5>
                        <p className="text-sm text-gray-600">{(payments as any[]).length} payment(s)</p>
                      </div>
                    ...
                    {!collapsedContacts[contactName] && (
                      <>
                        {viewMode === 'table' ? (
                          <div className="bg-white rounded-xl p-4 border border-gray-200 overflow-x-auto">
                            <table className="min-w-full rounded-xl overflow-hidden">
                              <thead className="bg-base-200 sticky top-0 z-10">
                                <tr>
                                  <th className="text-center px-4 py-3 font-bold text-lg">%</th>
                                  <th className="text-center px-4 py-3 font-semibold">Due Date</th>
                                  <th className="text-center px-4 py-3 font-semibold">Value + VAT</th>
                                  <th className="text-center px-4 py-3 font-semibold">VAT</th>
                                  ...
                                  <tr key={p.id} className="border-b border-gray-100 hover:bg-gray-50">
                                    ...
                                    <td className="align-middle text-center px-4 py-3 whitespace-nowrap">
                                      <div className="flex items-center justify-center gap-2">
                                        {p.paid ? (
                                          <span className="badge badge-success text-white border-none">
                                            Paid
                                          </span>
                                        ) : (
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                            {(payments as any[]).map((p) => (
                              <div key={p.id} className="card bg-base-100 shadow-lg border border-gray-200">
                                <div className="card-body p-4">
                                  <div className="flex items-center justify-between mb-3">
                                    <span className="text-lg font-bold text-purple-600">{p.duePercent}%</span>
                                    {p.paid ? (
                                      <span className="badge badge-success text-white border-none">
                                        Paid
                                      </span>
                                  ...
                                  <div className="space-y-2">
                                    ...
                                    <div className="flex items-center justify-between py-3">
                                      ...
                                      <span className="text-sm font-medium text-gray-900">{p.client}</span>
                                    </div>
                                  </div>
