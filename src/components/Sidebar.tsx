                    ...
                    <li key={index} className="relative">
                      {item.path && !hasSubItems && (
                        <Link
                          to={item.path}
                          onClick={onClose}
                          className={`flex items-center p-3 rounded-lg transition-all duration-200 hover:scale-105 hover:shadow-md ${isActive ? 'sidebar-active-purple text-white shadow-lg' : 'text-base-content'}`}
                        >
