...
const OfficeRentExpensesManager: React.FC<ExpenseManagerEmbedProps> = ({
  initialYear,
  initialMonth,
}) => {
  const now = new Date();
  ...
  return (
    <div className="w-full min-w-0 space-y-10">
      <GenericCRUDManager
        tableName="office_rent_expense"
        fields={rentFields}
        title="Monthly rent"
        description="Rent amount in NIS per office and calendar month"
        pageSize={20}
      ...
      <div className="border-t border-base-300/60 pt-8">
        <GenericCRUDManager
          tableName="rent_offices"
          fields={officeFields}
          title="Office location"
          description="Branches and offices (Ramat Gan, Jerusalem, etc.)"
          pageSize={20}
...
export default OfficeRentExpensesManager;
