...
export const LazyFinanceManagementPage = lazy(() => import('../pages/FinanceManagementPage'));
...
export const LazyPublicRecruitmentContractView = lazy(
  () => import('../pages/PublicRecruitmentContractView'),
);
...
export const LazyBoiExchangeRatesTestPage = lazy(() => import('../pages/BoiExchangeRatesTestPage'));
