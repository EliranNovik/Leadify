...
DROP FUNCTION IF EXISTS create_new_lead_v2(text, text, text, text, text, text, text);

-- Create function to create a new lead with automatic lead number generation and user tracking
CREATE OR REPLACE FUNCTION create_new_lead_v2(
  p_lead_name text,
