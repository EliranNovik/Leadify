-- Client portal: sub-efforts per lead case type (misc_category + sub_effort_misc_categories).
-- Auto-provisions missing lead_sub_efforts rows; dedupes by template; respects sort_order.
