-- Simple auth user creation using Supabase's built-in functions
...
-- Function to create user with password (simplified approach)
CREATE OR REPLACE FUNCTION create_user_with_auth_simple(
    user_email TEXT,
    user_password TEXT,
...
BEGIN
    ...
    -- Create user in auth system using minimal required fields
...
GRANT EXECUTE ON FUNCTION create_user_with_auth_simple(TEXT, TEXT, TEXT) TO authenticated;
